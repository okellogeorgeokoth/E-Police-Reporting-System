            ...
            <div class="col-lg-8">
              ...
              <div class="card shadow mb-4">
                <div class="card-header py-3">
                  <h6 class="m-0 font-weight-bold text-primary">Assigned Officers</h6>
                </div>
                  <div class="card-body">
<table class="table " >
                  <thead >
...
?>
         ...
         <div class="col-lg-4">
              ...
              <div class="card shadow mb-4">
               ...
               <h4><Marquee bgcolor="#000080" style="color: #FFFFFF; font-family: Book Antiqua" ><center>E-Police Reporting system You can check officer related to the case you have filed here on.</center></Marquee></h4><br><br>
        </div>
                    </div>
