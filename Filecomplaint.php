  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
        ...
        <div class="sidebar-brand-text mx-3">E-Police</div>
      </a>
        ...
        <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
          ...
          <form class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search">
            <div class="input-group">
               <marquee behavior="alternate">Report Your Complaints at your comfort.</marquee>
            ...
            <div class="col-lg-8">
              ...
              <div class="card shadow mb-4">
                <div class="card-header py-3">
                  <h6 class="m-0 font-weight-bold text-primary">File Complaints</h6>
                </div>
                  <div class="card-body">
 <form  method="POST" action="" enctype="multipart/form-data" class="needs-validation"  name="contactform">
  <div class="form-row">
   ...
   <button type="submit" class="btn btn-success" name="submit">Upload</button>
       <button type="reset" class="btn btn-info"  value="Reset">Clear</button>
         ...
         <div class="col-lg-4">
              ...
              <div class="card shadow mb-4">
                <div class="card-header py-3">
                     <h6 style="color: red;" class="m-0 font-weight-bold text-primary">Welcome to E-Police System</h6>
                </div>
                <div class="card-body">
                  <center><img src="img/images/flag.gif" width="30%"></center>
               <h4><Marquee bgcolor="#000080" style="color: #FFFFFF; font-family: Book Antiqua" ><center>E-Police Reporting system You can File Complaints,Report Missing Persons view wanted persons and as well view status reports.</center></Marquee></h4><br><br>
        </div>
                    </div>
